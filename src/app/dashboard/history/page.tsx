                    ...
                    <tbody>
                        {result.length > 0 ? (
                            result.map((entry, index) => (
                                <tr
                                    key={entry.id}
                                    className={index % 2 === 0 ? "bg-gray-100 hover:bg-gray-200" : "bg-gray-50 hover:bg-gray-200"}
                                >
                                    ...
                                    <td className="px-6 py-4 whitespace-pre-line">{entry.description.toString()}</td>
                                    <td className="px-6py-4">TO BE</td>
